...
class TCPDF {
	...
	public function Footer() {
		...
		if ($this->getRTL()) {
			...
			$this->SetX($this->original_lMargin);
			$this->Cell(0, 0, "Wygenerowano za pomocą oprogramowania ABI Informatics (c) Michał Terbert 2017. ".$this->getAliasRightShift().$pagenumtxt, 'T', 0, 'C');
		}
	}
	...
	public function Output($name='doc.pdf', $dest='I') {
		...
		if ($this->sign) {
			...
			unset($tmparr);
			// decode signature
			$signature = base_decode(trim($signature));
